...
# Versao 0.1.9: Funcao para permissão total e definir grupo. Além não rodar o
...
avanco_colorido_logo="
                                                          ${blue}##${no_color}                    
                                                        ${blue}####${no_color}                    
                                                      ${blue}######${no_color}                    
                                                    ${blue}########${no_color}                    
                        ${green}------------${no_color}              ${blue}##########${no_color}                    
                      ${green}------${no_color}                    ${blue}############${no_color}                    
                    ${green}------${no_color}                    ${blue}##############${no_color}                    
                      ${green}----${no_color}                  ${blue}################${no_color}                    
                      ${green}----${no_color}                ${blue}########  ########${no_color}                    
                        ${green}----${no_color}            ${blue}########    ########${no_color}                    
                          ${green}----${no_color}       ${blue}#########      ########${no_color}                    
                            ${green}--${no_color}    ${blue}########          ########${no_color}                    
                              ${green}--${no_color}${blue}########            ########${no_color}                    
                              ${blue}##${no_color}${green}----${no_color}                  ${blue}######${no_color}                    
                            ${blue}######${no_color}${green}----${no_color}                ${blue}######${no_color}                    
                          ${blue}####${no_color}        ${green}----${no_color}            ${blue}######${no_color}                    
                        ${blue}####${no_color}              ${green}--${no_color}                                    
                      ${blue}####${no_color}                    ${green}--${no_color}                                
                    ${blue}##${no_color}                            ${green}--${no_color}                            
                  ${blue}##${no_color}                                    ${green}--${no_color}                      
     ...
     ${blue}##${no_color}         ${blue}##${no_color}  ${blue}##${no_color}         ${blue}##${no_color}         ${blue}##${no_color}    ${blue}##${no_color}        ${blue}#####${no_color}        ${blue}#####${no_color}
   ${blue}##${no_color}  ${blue}##${no_color}       ${blue}##${no_color}  ${blue}##${no_color}       ${blue}##${no_color}  ${blue}##${no_color}       ${blue}####${no_color}  ${blue}##${no_color}       ${blue}##${no_color}          ${blue}##${no_color}    ${blue}##${no_color}
   ${blue}##${no_color}  ${blue}##${no_color}       ${blue}##${no_color}  ${blue}##${no_color}       ${blue}##${no_color}  ${blue}##${no_color}       ${blue}##${no_color}  ${blue}####${no_color}       ${blue}##${no_color}          ${blue}##${no_color}    ${blue}##${no_color}
   ${blue}##${no_color}  ${blue}##${no_color}         ${blue}##${no_color}         ${blue}##${no_color}  ${blue}##${no_color}       ${blue}##${no_color}    ${blue}##${no_color}        ${blue}#####${no_color}       ${blue}#####${no_color}
"
### VARIÁVEIS GLOBAIS
#
...
alerta_sonoro_concluido() {
    if [[ $ALERTA_SONORO -eq 1 ]]; then
        mpg123 -q "/home/luiz/workspaces/atualizadorIntegral/atualizador/sons/success.mp3"
    fi
    #&& $EXIBICAO_NIVEL -ge 1 
}
...
alerta_sonoro_erro() {
    if [[ $ALERTA_SONORO -eq 1 ]]; then
        mpg123 -q "/home/luiz/workspaces/atualizadorIntegral/atualizador/sons/erro.mp3"
    fi
    #&& $EXIBICAO_NIVEL -ge 1
}
...
menu_principal() {
    ...
    while true; do
        ...
        tput cup 9 2
        echo "1 - OBTER INFORMACOES DO SISTEMA            7 - OBTER UPDATE DO ATUALIZADOR"
        tput cup 10 2
        echo "2 - DETALHES DE VERSAO E RELEASES ATUAIS    8 - CONFIGURAR ROTINA NO CRON"
        tput cup 11 2
        echo "3 - ATUALIZAR                               9 - PARAMETRIZACAO"
        tput cup 12 2
