...
#
# DATA: 13/04/2024 11:27 - Versao 0.1.7
# -------------------------------------------------------------------------------
...
# Versão 0.1.7: Alterando comandos de download para curl com uso de -#
#
# -------------------------------------------------------------------------------
        ...
        while true; do
            ...
            "S" | "")
                ...
                (
                    ...
                    echo ""
                    echo "# ATUALIZADOR AUTOMATICO"
                    echo "0 $hora_informada * * $dia_definido /u/bats/atualizador --atu-cronb 2>> /u/sist/logs/.erro-cron.log"
                    echo ""
                ) | crontab -
                break 2
                ;;
...
baixar_extras() {
    ...
    if [ "$distro_nome" = "Debian" ]; then
        if [ ! -f "/u/bats/xmlstarlet" ]; then
            ...
            curl -k -L -# -o "/u/bats/xmlstarlet" "https://raw.githubusercontent.com/ketteiGustavo/atualizador/main/extras/xmlstarlet.Debian"
    ...
    if [ ! -f "/u/bats/gera-xml-por-tag.sh" ]; then
        ...
        curl -k -# -o "/u/bats/gera-xml-por-tag.sh" "https://raw.githubusercontent.com/ketteiGustavo/atualizador/main/extras/gera-xml-por-tag.sh"
