...
#
# DATA: 13/04/2024 11:27 - Versao 0.2.9
# -------------------------------------------------------------------------------
...
# Versão 0.2.8: Inserido opção de -a e --ajuda
#
# -------------------------------------------------------------------------------
...
OPCOES NA LINHA DE COMANDO:
    ...
    -o,  --obter        Obter detalhes de Versao e Release disponiveis no portal Avanco
    ...
    --permissoes        Conceder permissao total no 'sist/exec' (somente para usuario 'avanco')
    ...
    while true; do
        ...
        4)
            ...
            if [ -f "/u/sist/exec/cogumeloAzul.gnt" ]; then
                ...
                echo "FAVOR ACEITAR O INTEGRAL NOVAMENTE!"
